...
- **B (6–10)** — прийнятна
- **C (11–15)** — середня, варто спрощувати
- **D (16–25)** — висока, складно тестувати
- **E/F (26+)** — критична
...
## 4. Порівняння цикломатичної складності

Дані отримані інструментом `radon cc -s` (реальні виміри, скріншоти у розділі 2.3).
...
Детальне візуальне порівняння — див. **Діаграма 3** у розділі 2.3.

---

## 5. Висновок

Рефакторинг не змінив зовнішню поведінку системи, але суттєво покращив внутрішню якість коду:

- **Читабельність:** іменовані атрибути замість індексів, описові назви методів
- **Підтримуваність:** зміна однієї константи або методу впливає рівно на одне місце
- **Тестованість:** `get_sales_stats()` тестується без мокування stdout; методи класів ізольовані
- **Розширюваність:** новий тип доставки — одна строчка в `DELIVERY_COSTS`; новий рівень клієнта — один `elif`
